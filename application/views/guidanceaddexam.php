  ...
  <table class="table" id="myTable">
    ...
    ?>
      <tr>
       ...
       <td><a href="<?php echo site_url('Db_process/addstud_exam/'.$data_item1->exam_num); ?>"><button type="submit" onclick="return confirm_add('Add Exam?')" class="btn btn-default"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Exam </button></a></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
